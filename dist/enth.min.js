...
const defaultAttributeHandler = incrementalDomCjs_3[incrementalDomCjs_22.default];
incrementalDomCjs_3[incrementalDomCjs_22.default] = (element, name, value) => {
  if (name[0] === ".") {
...
function performRenderStep(htmlResult) {
  if (htmlResult) {
    ...
    if (type === "script") {
      const pointer = incrementalDomCjs_9();
      if (
        ...
        incrementalDomCjs_8().appendChild(newScript);
      } else {
        incrementalDomCjs_15();
      }
    } else {
      if (type) {
...
const defaultNodesDeleted = incrementalDomCjs_21.nodesDeleted;
incrementalDomCjs_21.nodesDeleted = function(nodes) {
...
export { $state, component, html, proxify, render, schedule };
